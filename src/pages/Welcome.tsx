...
export default function Welcome() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-5">
      ...
      >
        <span className="text-5xl font-[ArchitypeStedelijk] text-[var(--color-text-secondary)] leading-none h-[48px] flex items-center">F</span>
      </div>
      ...
      >
        <Button variant="primary" size="lg" onClick={() => navigate("/prompt")}>
